...
public class Test004 {
    public static void main(String[] args) {
        ...
        Date date_1 = new Date(8, 12,2022);
        Date date_2 = new Date(10,11,2022);
        Date date_3 = new Date(2, 10, 2022);

        // karo run
        
        Time time_1 = new Time(5, 30); 
        Time time_2 = new Time(12, 10);
        Time time_3 = new Time(1, 22);
        ...
        Time new_time1 = new Time(1,20);
        Time new_time2 = new Time(9,30);
        Time new_time3 = new Time(8,50);
        ...
        Collections.sort(arr_list,new SortByDareTime());
...
// bhai run tu karo isse
// bhai comparator tu bnao
// sortbydatetime naam se
// bhai array tu sort hu rhi he 
// arraylist ka masla he yes yes